...
#' @name prosper-models
#' @aliases param.ECHCG param.GALAP param.LOLRI
#' @seealso \code{\link{weed-parameters}} 

#' @description    PROSPER entails full parametrized models, which are described here. 
